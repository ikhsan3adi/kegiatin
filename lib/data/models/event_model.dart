...
abstract class EventModel with _$EventModel implements Event {
  ...
  const factory EventModel({
    ...
    @JsonKey(fromJson: JsonUtils.stringFromJson) required String description,
    required EventType type,
    required EventStatus status,
    required EventVisibility visibility,
    @JsonKey(fromJson: JsonUtils.stringFromJson) required String location,
    @JsonKey(fromJson: JsonUtils.stringFromJson) required String contactPerson,
    String? imageUrl,
    int? maxParticipants,
